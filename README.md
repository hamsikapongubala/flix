...
Learning about APIs and its implementations

## License

    Copyright [2018] [Hamsika Pongubala]
...
**Flixp** is a movies app displaying box office and top rental DVDs using [The Movie Database API](http://docs.themoviedb.apiary.io/#).
